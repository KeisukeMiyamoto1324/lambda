...
from src.eval.jsquad_perplexity.cli import parse_args
from src.eval.jsquad_perplexity.runtime import run_evaluation


def main() -> None:
    # ---------------------------------------------------------
    # Keep this script as a small entrypoint. Implementation
    # details live in focused JSQuAD perplexity modules.
    # ---------------------------------------------------------
    args = parse_args()
