...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-steps", type=int, default=48000)
    parser.add_argument("--num-workers", type=int, default=8)
    parser.add_argument("--val-batches", type=int, default=64)
    parser.add_argument("--validation-cache-path", type=str, default="")
    parser.add_argument("--val-check-interval", type=int, default=2500)
    parser.add_argument("--checkpoint-every-n-steps", type=int, default=2500)
    ...
    parser.add_argument("--output-path", type=str, default="models/lambda-360m")
